...
if (isset($_FILES['upload'])){
    #-- file upload is set, when user submited the form including a file------------------------------------------------------------------
    ...
    #-- strtolower creates lowercase, substr returns part of a string, strrpos finds the position of first occurrance of a substring in a string---
    #-- haystack = bunch of data you're looking at, $needle = what you are looking for------------------------------------------------------
    #-- +1 to move one step to right, so excluding the dot------------------------------------------------------
    ...
    #-- if extension e.g. png is in the allowedextensions array, then if statement runs ------------------------------------------------------   
    ...
    if(empty($error)){
    #-- if error array is empty it means that the previous if statements have not been true and there are no errors while uploading-----------
        ...
        <title>Security - Upload</title>
           ...
           <body>
               ...
               <div>
                   ...
                   <form action="" method="POST" enctype="multipart/form-data"><!-- specifies how the data will be encoded when submitted multipart = no characters -> needed for file upload -->
